    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h4><i class="bi bi-pencil"></i> Editar Aula</h4>
            </div>
            <div class="card-body">
                <form method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nome" 
                               value="<?php echo htmlspecialchars($aula['NOME_AULA'] ?? ''); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Avaliação</label>
                        <input type="text" class="form-control" name="avaliacao" 
                               value="<?php echo htmlspecialchars($aula['AVALIACAO'] ?? ''); ?>" required>
                    </div>
